...
describe("travelMinutes", () => {
  ...
  it("drives (faster per km) for longer distances", () => {
    const near = travelMinutes(at(46.3, 14.1), at(46.31, 14.1)); // ~1.1km*1.3 -> walk
    const far = travelMinutes(at(46.3, 14.1), at(46.4, 14.1)); // ~11km -> drive
...
describe("solveDay", () => {
  ...
  it("inserts travel legs between placed anchors", () => {
    const res = solveDay({
      ...
      dayEnd: "20:00",
      anchors: [
        { id: "a", title: "Castle", durationMin: 60, location: at(46.39, 14.1) },
        { id: "b", title: "Gorge", durationMin: 60, location: at(46.4, 14.05) },
      ],
      mealWindows: [],
    });
