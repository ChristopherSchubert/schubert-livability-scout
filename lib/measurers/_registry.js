...
import walkingCore from "./walking-core.js";
...
export const REGISTRY = [
  ...
  sursObcina,
  walkscore,
  // Plateau-decay weighted POI sums (Google Places cache). After osm-core
  // so the legacy _n counts and the new _score values land in the same
  // measurement cycle while we're double-running; it'll outlive osm-core
  // for the Aliveness inputs once we deprecate the _n counts.
  walkingCore,
];
