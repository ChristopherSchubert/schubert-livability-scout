...
// (visitClimateSeed — the normalizeState fallback seed — stays in
// planner-data.js next to its only caller, not here; it isn't visit-window
// logic, it just sat adjacent in the original godfile.)
