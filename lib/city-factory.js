// City factory + per-user state — extracted from lib/planner-data.js
// (godfile split, #47). The starterCities seed, the city() factory it
// calls, and normalizeState/defaultState. Re-exported from
// planner-data.js so existing import paths keep working. (starterCities
// is in-source seed data — debt to migrate to Supabase, tracked separately.)
