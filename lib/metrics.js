...
export const metricTaxonomy = [
  {
    ...
    metrics: [
      ...
      { key: "mtn_horizon_pct",  label: "Mountains on the horizon", tagline: "Share of horizon ring with a visible peak silhouette", unit: "%",   dir: +1, theme: "stone", source: "Open-Meteo elevation + OSM peaks", sourceUrl: "https://open-meteo.com/en/docs/elevation-api" },
      ...
      { key: "water_extent_km2", label: "Water grandeur",         tagline: "Size of the targeted body",             unit: "km²", dir: +1, theme: "water", source: "OpenStreetMap (Overpass)",    sourceUrl: "https://overpass-api.de" },
    ],
  },
  {
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: "clear_days",        label: "Sunny days / yr",     tagline: "Shortwave ≥ 70 % of clear-sky",           unit: "days",  dir: +1, theme: "sun", source: "NASA POWER (MERRA-2) daily archive (2019–2023)", sourceUrl: "https://power.larc.nasa.gov/docs/services/api/temporal/daily/" },
    ],
  },
];
