...
export const metricTaxonomy = [
  {
    ...
    metrics: [
      ...
      { key: "water_extent_km2", label: "Water grandeur (extent)",  unit: "km²", dir: +1, source: "OpenStreetMap (Overpass)",    sourceUrl: "https://overpass-api.de" },
      { key: "skyline_deg",    label: "Visible mountain backdrop",  unit: "°",   dir: +1, source: "Open-Meteo elevation (line-of-sight skyline)", sourceUrl: "https://open-meteo.com/en/docs/elevation-api" },
    ],
  },
  {
