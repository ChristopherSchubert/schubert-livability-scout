...
export const cityWhyByCity = {
  ...
  "Old Town Alexandria, VA": "Old Town Alexandria belongs because it combines colonial pedestrian fabric with year-round civic life and a working Potomac waterfront. King Street offers continuous cafes, restaurants, and indie retail from Market Square all the way down to the water, stitched together by cobblestone side streets and the Mount Vernon Trail. The question to test is whether the proximity to D.C. and the federal-job economy make it feel like an actual lived-in neighborhood or whether it tilts into commute-town and tourist-shopping mode.",
  "Lewes, DE": "Lewes belongs because it is the closest American analog to a Piran-scale Atlantic seaport: small enough to walk end-to-end in fifteen minutes, with a working bay, a real downtown of brick storefronts, and a residential mix that does not collapse outside summer. The Cape May–Lewes Ferry and Cape Henlopen tie everyday life to water and sand directly off the center. The test is whether the town stays alive in winter or hollows into a shoulder-season postcard.",
  "New Castle, DE": "New Castle belongs because it preserves an intact colonial street grid in a way almost no other Mid-Atlantic town does. Delaware Street and the Green retain their original scale, Battery Park puts the river directly at the edge of the historic core, and the whole place reads as a tiny lived-in museum that someone still has to mow on Saturdays. The question is whether the historic perfection is enough to anchor real daily routines without slipping into a closed-on-Tuesdays village.",
  "Mystic, CT": "Mystic belongs because it pulls off a tight seaport core split by a river and a bascule bridge that physically pivots open multiple times a day. The downtown is small but continuous, the river is the actual center of the place, and the working-boat presence keeps it from drifting fully into tourist territory. The question is whether the daily rhythm survives once the summer crowds leave and the seafood shacks close.",
  "Litchfield, CT": "Litchfield belongs because it is the archetypal New England town-green model executed at full size. The Green is genuinely the room the town gathers in, the surrounding white-clapboard fabric is unbroken for blocks, and the rural Litchfield Hills are immediate without requiring a drive. The test is whether the place reads as alive year-round or whether it shows its colors as a weekend-house town that empties Monday through Thursday.",
  "Essex, CT": "Essex belongs because it is one of the most compact and intact riverfront villages on the Connecticut River. A single main street ends directly at a working dock with sailboats year-round, the side streets stay residential and walkable, and the scale is small enough to feel like a stage set you actually live on. The question is whether a village this small can support enough ordinary daily life beyond the marina-and-inn economy.",
  "Newport, RI": "Newport belongs because the historic peninsula carries actual maritime fabric — narrow streets, working harbor, year-round residents — alongside the Gilded Age scenery. Thames Street, the wharves, and the side streets between Memorial Boulevard and the harbor form a continuous walkable core, and Cliff Walk delivers ocean drama without requiring a drive. The risk is that summer tourism so dominates the calendar that the off-season rhythm reveals a different, thinner place.",
  "Bristol, RI": "Bristol belongs because it sits between Providence and Newport with much less polish and a more lived-in fabric than either. Hope Street runs the spine of a small town that meets the bay at multiple points, and the East Bay Bike Path threads through it. The test is whether 'between' is the right word for a place to be, or whether it falls into the gap between two more dramatic neighbors.",
  "Northampton, MA": "Northampton belongs because it is a college-town downtown that punches well above its size: continuous independent retail, a real music and food scene, and intellectual energy from Smith and the surrounding Five Colleges. The Mill River and Mount Tom give the Pioneer Valley a real landscape, and the bike-path system stitches everything together without needing a car. The test is whether the rhythm holds when classes are out, and whether the cultural depth offsets a longer winter than most candidates.",
};
...
export const starterCities = [
  ...
  city("Old Town Alexandria, VA", "Old Town / King Street", "King St & Union St", "Unscheduled", cityWhyByCity["Old Town Alexandria, VA"], "King Street holds public life in winter and the riverfront feels like part of daily routine.", "It reads as commute-town with a shopping strip, not a real neighborhood.", [
  ...
  city("Lewes, DE", "Second Street / Lewes Beach", "Second St & Market St", "Unscheduled", cityWhyByCity["Lewes, DE"], "A small-scale waterfront town that holds public life through off-season.", "Beach town that hibernates and reveals a thin year-round core.", [
  ...
  city("New Castle, DE", "Historic District / The Strand", "Delaware St & 2nd St", "Unscheduled", cityWhyByCity["New Castle, DE"], "The historic district reads as lived-in, not a stage set.", "Too small, too quiet, or too closed Tuesday for real daily life.", [
  ...
  city("Mystic, CT", "Downtown Mystic / Mystic River", "W Main St & Bank St", "Unscheduled", cityWhyByCity["Mystic, CT"], "Downtown holds together in shoulder season and the river is the actual center.", "Summer-only seafood-town economy with not much left in February.", [
  ...
  city("Litchfield, CT", "Litchfield Green / North Street", "North St & West St", "Unscheduled", cityWhyByCity["Litchfield, CT"], "The Green reads as a year-round civic room, not a postcard background.", "Pretty but empty mid-week; weekend-house town when you scratch the surface.", [
  ...
  city("Essex, CT", "Main Street Essex Village", "Main St & Pratt St", "Unscheduled", cityWhyByCity["Essex, CT"], "Compact perfection at a scale that still supports daily errands.", "Too small to sustain anything beyond the marina-inn axis.", [
  ...
  city("Newport, RI", "Historic Hill / Thames Street", "Thames St & Bowen's Wharf", "Unscheduled", cityWhyByCity["Newport, RI"], "The historic peninsula has actual year-round residential rhythm.", "Summer-tourism dominance reveals a thinner off-season place.", [
  ...
  city("Bristol, RI", "Hope Street / Bristol Harbor", "Hope St & State St", "Unscheduled", cityWhyByCity["Bristol, RI"], "Hope Street functions as a real daily spine without needing the postcard places nearby.", "Stuck between Providence and Newport with neither's intensity.", [
  ...
  city("Northampton, MA", "Downtown Northampton / Smith College edge", "Main St & Pleasant St", "Unscheduled", cityWhyByCity["Northampton, MA"], "Cultural and pedestrian density survive when school is out.", "Too cold, too college-cycle dependent, or too inland for a Piran-like feel.", [
