...
export const metricTaxonomy = [
  {
    ...
    metrics: [
      ...
      { key: "mtn_horizon_pct",  label: "Mountains on the horizon", tagline: "Share of horizon ring with peaks ≥ 2°", unit: "%",   dir: +1, source: "Open-Meteo elevation + OSM peaks", sourceUrl: "https://open-meteo.com/en/docs/elevation-api" },
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: "bldg_coverage",    label: "Building coverage",    tagline: "Built footprint ÷ 700 m core area",       unit: "frac", dir: +1, source: "OpenStreetMap (osmnx)", sourceUrl: "https://www.openstreetmap.org" },
      ...
      { key: "street_km",        label: "Street length",        tagline: "Total walkable street length in core",    unit: "km",   dir: +1, source: "OpenStreetMap (osmnx)", sourceUrl: "https://www.openstreetmap.org" },
    ],
  },
  {
...
function settingScore(cityItem) {
  ...
  return Math.round((0.8 * Math.max(m, w) + 0.2 * Math.min(m, w)) * 10) / 10;
}
