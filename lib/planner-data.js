// Felt-score survey lives in its own module now (godfile split, #47). Imported
// for internal use (surveyComplete/emptySurvey are used below) and re-exported
// just below so `from "./planner-data"` imports are unchanged.
import {
  surveyAxes,
  SLOVENIA_ANCHORS,
  emptySurvey,
...
export const STAGES = [
  {
    id: "backlog",
    label: "Backlog",
    help: "Candidates not yet in planning. Triage here or in Ranking.",
  },
  {
    id: "planning",
    label: "Planning",
    help: "Working the trip — rank the city and find its best week.",
  },
  ...
  { id: "visited", label: "Visited", help: "Back from the trip. Run the post-visit survey." },
  {
    id: "assessed",
    label: "Assessed",
    help: "Surveyed and decided: advance, winter-revisit, or eliminate.",
  },
];
...
export function cityStage(cityItem, today = new Date()) {
  ...
  if (decision === "Advance" || decision === "Eliminate" || decision === "Winter Revisit")
    return "assessed";
  ...
  if (cityItem.status === "Scheduled" || cityItem.status === "Shortlist" || arrive)
    return "planning";
  return "backlog";
}
...
export const metricTaxonomy = [
    ...
    metrics: [
      {
        ...
        tagline: "Steepest visible horizon rise",
        unit: "°",
        dir: +1,
        source: "Open-Meteo elevation (line-of-sight skyline)",
        sourceUrl: "https://open-meteo.com/en/docs/elevation-api",
      },
      {
        key: "mtn_horizon_pct",
        label: "Mountains on the horizon",
        tagline: "Share of horizon ring with a visible peak silhouette",
        unit: "%",
        dir: +1,
        source: "Open-Meteo elevation + OSM peaks",
        sourceUrl: "https://open-meteo.com/en/docs/elevation-api",
      },
      {
        key: "water_dist_m",
        label: "Distance to water",
        tagline: "To nearest sea, river, or lake edge",
        unit: "m",
        dir: -1,
      ...
      {
        key: "water_extent_km2",
        label: "Water grandeur",
        tagline: "Size of the targeted body",
        unit: "km²",
        dir: +1,
        source: "OpenStreetMap (Overpass)",
        sourceUrl: "https://overpass-api.de",
  ...
  },
  {
    ...
    metrics: [
      ...
      {
        key: "cafe_score",
        label: "Cafés (weighted)",
        tagline: "Plateau-decay sum in 1500 m walking core",
        unit: "score",
        dir: +1,
      ...
      {
        key: "cafe_n",
        label: "Cafés (raw count)",
        tagline: "Legacy: in 700 m hard ring",
        unit: "count",
        dir: +1,
        source: "OpenStreetMap (Overpass)",
        sourceUrl: "https://www.openstreetmap.org",
        supersededBy: "cafe_score",
      },
      {
        key: "bar_n",
        label: "Bars (raw count)",
        tagline: "Legacy: in 700 m hard ring",
        unit: "count",
        dir: +1,
        source: "OpenStreetMap (Overpass)",
        sourceUrl: "https://www.openstreetmap.org",
        supersededBy: "bar_score",
      },
      {
        key: "rest_n",
        label: "Restaurants (raw count)",
        tagline: "Legacy: in 700 m hard ring",
        unit: "count",
        dir: +1,
        source: "OpenStreetMap (Overpass)",
        sourceUrl: "https://www.openstreetmap.org",
        supersededBy: "rest_score",
      },

      {
        key: "walk_score",
        label: "Walk Score",
        tagline: "Errand-walkability, 0–100",
        unit: "0–100",
        dir: +1,
      ...
      {
        key: "walk_transit_commute_pct",
        label: "Walk + transit commute",
        tagline: "Workers commuting on foot or transit",
        unit: "%",
        dir: +1,
        source: "US Census ACS (B08301)",
  ...
  },
  {
    ...
    metrics: [
      {
        key: "intersection_den",
        label: "Intersection density",
        tagline: "3+ way intersections / km² (fine grid)",
        unit: "/km²",
        dir: +1,
      ...
      {
        key: "mean_block_m",
        label: "Mean block length",
        tagline: "Shorter blocks = finer fabric",
        unit: "m",
        dir: -1,
        source: "OpenStreetMap (osmnx)",
        sourceUrl: "https://www.openstreetmap.org",
      ...
      {
        key: "carfree_frac",
        label: "Car-free streets",
        tagline: "Share of street length pedestrian-only",
        unit: "frac",
        dir: +1,
        source: "OpenStreetMap (osmnx)",
        sourceUrl: "https://www.openstreetmap.org",
      },
      {
        ...
        tagline: "Built footprint ÷ land area in 700 m core",
        unit: "frac",
        dir: +1,
        source: "OpenStreetMap (osmnx)",
        sourceUrl: "https://www.openstreetmap.org",
      ...
      {
        key: "pre1940_pct",
        label: "Pre-1940 housing",
        tagline: "Share of homes built before 1940",
        unit: "%",
        dir: +1,
        source: "US Census ACS (B25034)",
        sourceUrl: "https://data.census.gov",
      },
    ],
  },
  {
    ...
    metrics: [
      {
        key: "daily_needs_score",
        label: "Daily-needs shops (weighted)",
        tagline: "Plateau-decay sum in 1500 m walking core",
        unit: "score",
        dir: +1,
        source: "Google Places (New) via local cache",
      ...
      {
        key: "daily_needs_n",
        label: "Daily-needs shops (raw count)",
        tagline: "Legacy: groceries, pharmacy, bakery in 700 m hard ring",
        unit: "count",
        dir: +1,
        source: "OpenStreetMap (Overpass)",
        sourceUrl: "https://www.openstreetmap.org",
        supersededBy: "daily_needs_score",
      },
      {
        key: "core_density",
        label: "Core density",
        tagline: "People per sq mi in the visit tract",
        unit: "/sqmi",
        dir: +1,
        source: "US Census ACS (tract)",
        sourceUrl: "https://data.census.gov",
      },
      {
        key: "owner_occ_pct",
        label: "Owner-occupied",
        tagline: "Share of occupied homes lived in by owner",
        unit: "%",
        dir: +1,
        source: "US Census ACS (B25003)",
        sourceUrl: "https://data.census.gov",
      },
      {
        key: "seasonal_vac_pct",
        label: "Seasonal-vacancy",
        tagline: "Homes vacant for seasonal use",
        unit: "%",
        dir: -1,
        source: "US Census ACS (B25004)",
        sourceUrl: "https://data.census.gov",
      },
      {
        key: "median_price_usd",
        label: "Median home value",
        tagline: "Tract median — financial distortion",
        unit: "$",
        dir: -1,
        source: "US Census ACS (B25077)",
        sourceUrl: "https://data.census.gov",
      },
      {
        key: "price_to_income_ratio",
        label: "Price-to-income",
        tagline: "Median home value ÷ median household income",
        unit: "ratio",
        dir: -1,
        source: "US Census ACS (B25077 ÷ B19013)",
        sourceUrl: "https://data.census.gov",
      },
    ],
  },
  {
    ...
    metrics: [
      {
        key: "pleasant_days",
        label: "Pleasant days / yr",
        tagline: "Mean 55–80°F and dry",
        unit: "days",
        dir: +1,
        source: "NASA POWER (MERRA-2) daily archive (2019–2023)",
        sourceUrl: "https://power.larc.nasa.gov/docs/services/api/temporal/daily/",
      },
      {
        key: "days_below_freeze",
        label: "Cold days / yr",
        tagline: "Low temperature below 32°F",
        unit: "days",
        dir: -1,
        source: "NASA POWER (MERRA-2) daily archive (2019–2023)",
        sourceUrl: "https://power.larc.nasa.gov/docs/services/api/temporal/daily/",
      },
      {
        key: "hot_days",
        label: "Hot days / yr",
        tagline: "High temperature above 85°F",
        unit: "days",
        dir: -1,
        source: "NASA POWER (MERRA-2) daily archive (2019–2023)",
        sourceUrl: "https://power.larc.nasa.gov/docs/services/api/temporal/daily/",
      },
      {
        key: "clear_days",
        label: "Sunny days / yr",
        tagline: "Shortwave ≥ 70 % of clear-sky",
        unit: "days",
        dir: +1,
        source: "NASA POWER (MERRA-2) daily archive (2019–2023)",
        sourceUrl: "https://power.larc.nasa.gov/docs/services/api/temporal/daily/",
...
export const metricMethod = {
  relief_std_m:
    "Std-dev of ground elevation across a 6×6 grid over the 700m core. Higher = more dramatic terrain.",
  relief_range_m: "Highest minus lowest elevation across that same grid.",
  water_dist_m:
    "Straight-line distance to the nearest major water (sea / named river / sizable lake), measured to its actual edge, not the centroid — and to the body you've chosen as the target.",
  water_extent_km2:
  ...
  skyline_deg:
    "How high the visible land rises above your eyeline. Marches outward along 24 directions to ~55 km, corrects for earth curvature + refraction, and takes the steepest skyline angle you'd actually see. Captures a mountain backdrop (e.g. the Santa Ynez over Santa Barbara) that local relief misses.",
  mtn_horizon_pct:
    "Share of the surrounding horizon (16 compass sectors) where a visible peak presents a silhouette ≥ 0.5° — how much of the ring is filled by mountains, from a looming alpine wall to the distant skyline of a range across open water. Occlusion-tested against terrain rays starting at 500 m so close-foreground bluffs correctly block the ridges behind them.",
  cafe_score:
    "Weighted café score: every café (incl. coffee shop, bakery) within 1500 m of the visit anchor, with weights decaying smoothly past a 500 m plateau. Full credit for spots inside the 5-min walk; gentle falloff out to ~15-min walk; zero beyond.",
  bar_score:
    "Weighted bar score: same shape as cafe_score, applied to bars, pubs, wine bars, cocktail bars, breweries.",
  rest_score:
    "Weighted restaurant score: same shape as cafe_score, applied to restaurants (all cuisines), fast food, sandwich shops, ice cream.",
  cafe_n:
    "Legacy raw count of cafés within 700 m. Superseded by cafe_score; still measured for sanity checking, not used in the Aliveness composite.",
  ...
  intersection_den:
    "Street intersections (3+ ways meeting) per km² in the core. Higher = a finer, more connected grid.",
  mean_block_m:
    "Mean street-segment length in the core. Shorter blocks = a more walkable, human-scaled grid.",
  carfree_frac: "Share of street length that's pedestrian / footway / living-street in the core.",
  bldg_coverage:
    "Building-footprint area ÷ land area within the 700 m core (water is subtracted from the denominator). How densely built the fabric is, fairly judged on peninsula and lakeside cores.",
  daily_needs_score:
    "Weighted daily-needs score: groceries, pharmacy, market, butcher within 1500 m, with weights decaying past a 500 m plateau — can you live day-to-day on foot.",
  daily_needs_n:
    "Legacy raw count of daily-needs shops within 700 m. Superseded by daily_needs_score.",
  core_density:
    "People per square mile in the Census tract holding the visit center. Higher = a lived-in core.",
  owner_occ_pct:
    "Share of occupied homes lived in by their owner (tract-level). High = roots, not transient renters or absentee landlords.",
  pre1940_pct:
    "Share of housing units in the tract built before 1940. Higher = an older, more historically continuous fabric.",
  walk_transit_commute_pct:
    "Share of workers (16+) commuting on foot or by transit (incl. taxicab). The 'people actually walk to work' companion to Walk Score's destination-density measurement.",
  price_to_income_ratio:
    "Tract median home value ÷ tract median household income. The direct affordability check — low means locals can still buy in; high means the market has detached from local incomes (a resort signal).",
  median_income_usd:
    "Median household income for the tract (12-month, dollars). Stored as the denominator for the price-to-income ratio; not surfaced as its own headline metric.",
  seasonal_vac_pct:
    "Share of homes vacant for seasonal/recreational use (tract-level). High = a resort that hollows out off-season.",
  median_price_usd:
    "Median home value for the tract. A read on how financially distorted the place is.",
  pleasant_days:
    "Days per year with mean temperature between 55–80°F and no measurable precipitation — the year-round 'shirt-sleeve weather' count.",
  days_below_freeze:
    "Days per year the low drops below freezing (recent-years normal). Lower is better.",
...
export function learnedAxisWeights(cities) {
  ...
  if (samples.length < LEARN_MIN_SAMPLES)
    return { weights: null, n: samples.length, need: LEARN_MIN_SAMPLES };
  const mean = (a) => a.reduce((s, v) => s + v, 0) / a.length;
  const ys = samples.map((s) => s.y),
    my = mean(ys);
  const weights = {};
  calibrateAxes.forEach(([key], i) => {
    const xs = samples.map((s) => s.x[i]),
      mx = mean(xs);
    let num = 0,
      dx = 0,
      dy = 0;
  ...
  if (avg > 0)
    for (const k of Object.keys(weights)) weights[k] = Math.round((weights[k] / avg) * 100) / 100;
...
const visitClimateSeed = {
  "Santa Barbara, CA": {
    notes: {
      ...
      offSeason:
        "Mild and quiet — downtown on a gray winter weekday, the locals' version of the town.",
    },
  },
  "Savannah, GA": {
    notes: {
      prime:
        "The heat and humidity break, the squares are perfect, and the spring-festival crowds are long gone.",
...
export function cityVisitWindow(cityItem) {
  ...
  const comfortable = withFit.filter(
    (mo) => mo.comfort >= 3.5 && (!offSeason || mo.idx !== offSeason.idx)
  );
  const primePool = comfortable.length
    ? comfortable
    : withFit.filter((mo) => !offSeason || mo.idx !== offSeason.idx);
...
// Felt-score survey (Track 2) — imported at the top from lib/survey.js (#47);
// re-exported here so existing `from "./planner-data"` imports are unchanged.
export { surveyAxes, SLOVENIA_ANCHORS, emptySurvey, surveyComplete, feltScore, baselineReferences };
...
export const starterCities = [
  city(
    "Santa Barbara, CA",
    "Lower State / Funk Zone / West Beach",
    "State St & Yanonali St",
    "Jun week 1",
    "",
    "You want beauty and daily walkability more than anti-wealth vibes.",
    "It feels too polished, expensive, or resort-adjacent.",
    [
  ...
  city(
    "Ventura, CA",
    "Downtown Ventura / Pier",
    "Main St & California St",
    "Jun week 3",
    "",
    "You found the less-grand, more usable Santa Barbara.",
    "It feels too casual or thin after Slovenia.",
    [
  ...
  city(
    "San Luis Obispo, CA",
    "Mission Plaza / Higuera / Garden",
    "Higuera St & Chorro St",
    "Jul week 1",
    "",
    "You want compact daily ease more than direct ocean drama.",
    "It feels too inland or college-town small.",
    [
  ...
  city(
    "Santa Cruz, CA",
    "Downtown / Beach Hill edge",
    "Pacific Ave & Cooper St",
    "Jul week 3",
    "",
    "You like a little edge with your beauty.",
    "It feels too studenty, chaotic, or expensive for the polish level.",
    [
  ...
  city(
    ...
    "Pacific Grove downtown",
    "Lighthouse Ave & 17th St",
    "Aug week 1",
    "",
    "Coastal-town feeling matters more than nightlife.",
    "It feels too sleepy or retiree-coded.",
    [
  ...
  city(
    ...
    "Aug week 3",
    "",
    "Mountain-water-sport energy is your Bled substitute.",
    "Winter wind, gray, or housing scarcity dulls the everyday appeal.",
    [
  ...
  city(
    ...
    "Sep week 1",
    "",
    "You want realness, water, trails, and texture.",
    "The winter darkness or split between Fairhaven and downtown wears on you.",
    [
  ...
  city(
    "Ashland, OR",
    "Plaza / Lithia Park edge",
    "N Main St & E Main St",
    "Sep week 3",
    "",
    "You want a small civic place with nature touching downtown.",
    "It feels too small or too dependent on visitor seasons.",
    [
      "Ashland Plaza",
  ...
  city(
    "Annapolis, MD",
    "City Dock / Historic Core",
    "Main St & Dock St",
    "Oct week 1",
    "",
    "Harbor public life matters more than West Coast nature.",
    "Humidity, tourism, or mid-Atlantic dampness takes it down.",
    [
  ...
  city(
    ...
    "Oct week 3",
    "",
    "Squares, shade, walking, and atmosphere beat mountain drama.",
    "Summer heat and tourism overwhelm livability.",
    [
  ...
  city(
    ...
    "Nov week 1",
    "",
    "You want Southern urban energy with year-round outdoor life.",
    "Wealth, tourist pressure, flooding, or heat makes it feel wrong.",
    [
  ...
  city(
    "St. Petersburg, FL",
    "Downtown Waterfront / Edge District",
    "Beach Dr NE & 2nd Ave NE",
    "Nov week 3",
    "",
    "Waterfront urbanism and winter public life beat old-world charm.",
    "Heat, insurance, or Florida car culture outside the core becomes too much.",
    [
  ...
  city(
    ...
    "Unscheduled",
    "",
    "You want Piran-scale waterfront public life without needing a big-city backdrop.",
    "It feels too quiet, too humid, or too retirement-oriented outside the best blocks.",
    [
  ...
  city(
    "St. Augustine, FL",
    "Historic Downtown / Bridge of Lions",
    "St George St & Hypolita St",
    "Unscheduled",
    "",
    "You want the closest Florida version of an old-world walking town.",
    "The tourist concentration overwhelms normal daily life or grocery-level practicality.",
    [
  ...
  city(
    "Greenville, SC",
    "Main Street / Falls Park",
    "S Main St & Falls Park Dr",
    "Unscheduled",
    "",
    "You want public realm, restaurants, and easier cost structure more than coastal romance.",
    "It feels too engineered, too inland, or too conventional compared with Slovenia.",
    [
  ...
  city(
    "Petaluma, CA",
    "Historic Downtown / Turning Basin",
    "Petaluma Blvd N & Western Ave",
    "Unscheduled",
    "",
    "You want California climate and texture without fully entering resort wealth.",
    "It does not have enough setting drama to compete with the benchmark towns.",
    [
  ...
  city(
    ...
    "Ocean Ave / Carmel Beach",
    "Ocean Ave & Dolores St",
    "Unscheduled",
    "",
    "Beauty, walkability, and winter climate outweigh discomfort with moneyed polish.",
    "It confirms that hyper-wealthy resort perfection is not the life you want.",
    [
  ...
  city(
    ...
    "Unscheduled",
    "",
    "You want harbor-town public life and Boston access more than mild winter perfection.",
    "Winter damp/cold shrinks public life too much.",
    [
  ...
  city(
    "Cape May, NJ",
    "Washington Street Mall / Beach Ave",
    "Washington St & Decatur St",
    "Unscheduled",
    "",
    "You want a compact seaside walking town and can tolerate shoulder-season quiet.",
    "It empties out too much after holidays and becomes more resort than home.",
    [
  ...
  city(
    "Durango, CO",
    "Main Avenue / Animas River",
    "Main Ave & 9th St",
    "Unscheduled",
    "",
    "You want Bled's mountain energy more than coastal softness.",
    "Winter still makes the rhythm feel too cold or too seasonal.",
    [
  ...
  city(
    "Charlottesville, VA",
    "Downtown Mall / Court Square",
    "E Main St & 2nd St SE",
    "Unscheduled",
    "",
    "You want a pedestrian public room with intellectual/cultural life.",
    "The surrounding city does not live up to the mall, or the college-town politics feel heavy.",
    [
  ...
  city(
    ...
    "Unscheduled",
    "",
    "You want character, hills, porches, and local weirdness more than polish.",
    "The town is too small, too tourist-dependent, or too disconnected from larger systems.",
    [
  ...
  city(
    ...
    "Unscheduled",
    "",
    "King Street holds public life in winter and the riverfront feels like part of daily routine.",
    "It reads as commute-town with a shopping strip, not a real neighborhood.",
    [
  ...
  city(
    "Lewes, DE",
    "Second Street / Lewes Beach",
    "Second St & Market St",
    "Unscheduled",
    "",
    "A small-scale waterfront town that holds public life through off-season.",
    "Beach town that hibernates and reveals a thin year-round core.",
    [
  ...
  city(
    "New Castle, DE",
    "Historic District / The Strand",
    "Delaware St & 2nd St",
    "Unscheduled",
    "",
    "The historic district reads as lived-in, not a stage set.",
    "Too small, too quiet, or too closed Tuesday for real daily life.",
    [
  ...
  city(
    "Mystic, CT",
    "Downtown Mystic / Mystic River",
    "W Main St & Bank St",
    "Unscheduled",
    "",
    "Downtown holds together in shoulder season and the river is the actual center.",
    "Summer-only seafood-town economy with not much left in February.",
    [
  ...
  city(
    "Litchfield, CT",
    "Litchfield Green / North Street",
    "North St & West St",
    "Unscheduled",
    "",
    "The Green reads as a year-round civic room, not a postcard background.",
    "Pretty but empty mid-week; weekend-house town when you scratch the surface.",
    [
  ...
  city(
    "Essex, CT",
    "Main Street Essex Village",
    "Main St & Pratt St",
    "Unscheduled",
    "",
    "Compact perfection at a scale that still supports daily errands.",
    "Too small to sustain anything beyond the marina-inn axis.",
    [
  ...
  city(
    "Newport, RI",
    "Historic Hill / Thames Street",
    "Thames St & Bowen's Wharf",
    "Unscheduled",
    "",
    "The historic peninsula has actual year-round residential rhythm.",
    "Summer-tourism dominance reveals a thinner off-season place.",
    [
  ...
  city(
    "Bristol, RI",
    "Hope Street / Bristol Harbor",
    "Hope St & State St",
    "Unscheduled",
    "",
    "Hope Street functions as a real daily spine without needing the postcard places nearby.",
    "Stuck between Providence and Newport with neither's intensity.",
    [
  ...
  city(
    "Northampton, MA",
    "Downtown Northampton / Smith College edge",
    "Main St & Pleasant St",
    "Unscheduled",
    "",
    "Cultural and pedestrian density survive when school is out.",
    "Too cold, too college-cycle dependent, or too inland for a Piran-like feel.",
    [
...
export function city(
  ...
  return {
    id:
      ...
      `${slugify(name)}-${Math.random().toString(36).slice(2, 10)}`,
    name,
    ...
    days: [
      {
        ...
        plan: "Check in, walk the heart intersection, find an ordinary dinner, and note whether the place feels alive after dark.",
      },
      {
        title: "Normal weekday",
        plan: "Coffee, grocery run, work block, neighborhood walk, casual dinner. Watch who is outside and why.",
      },
      {
        title: "Nature day",
        plan: "Test the closest high-value nature access without making it feel like a vacation production.",
      },
    ],
    checklists: {
      before: [
...
export function focusAreaSearchSubject(block) {
  ...
  if (landmark) {
    ...
    return anchor && !new RegExp(`\\b${escapeRegExp(landmark)}\\b`, "i").test(anchor)
      ? `${anchor} ${landmark}`
      : landmark;
  }
...
export function leadingPlaceAnchor(block) {
  return cleanSearchPlace(
    String(block || "").split(/\s+\/\s+|\s+near\s+|\s+around\s+|\s+at\s+/i)[0]
  );
}
...
export function landmarkSearchSubject(value) {
  ...
  return (
    landmarks.find((landmark) => new RegExp(`\\b${escapeRegExp(landmark)}\\b`, "i").test(value)) ||
    ""
  );
}
...
export function blockRepresentativeSubject(block) {
  ...
  if (/\byanonali|helena|funk zone\b/i.test(clean))
    return "Funk Zone restaurants wine tasting street scene";
  if (/\banacapa\b/i.test(clean)) return "Anacapa Street courthouse downtown street scene";
  if (/\bstate st|state street\b/i.test(clean))
    return "Lower State Street downtown outdoor dining pedestrians";
  if (/\bstearns wharf|cabrillo|wharf\b/i.test(clean))
    return "Stearns Wharf waterfront promenade beach";
  if (/\bmission plaza|plaza|square|state circle|court square|market square\b/i.test(block))
    return `${clean} plaza public square people`;
  if (/\bwaterfront|harbor|dock|pier|promenade|bay|river|turning basin|ego alley\b/i.test(block))
    return `${clean} waterfront promenade people`;
  if (/\bpark|trail|beach|bridge|lighthouse|falls|creek\b/i.test(block))
    return `${clean} public outdoor gathering`;
  if (/\bmall|market|main st|main street|avenue|ave|street|st\b/i.test(block))
    return `${clean} street life outdoor dining shops`;
...
const focusAreaAnchorByCity = {
  ...
  "Monterey / Pacific Grove, CA": {
    ...
    "Forest Ave between Lighthouse Ave and Central Ave":
      "Pacific Grove Museum of Natural History district",
...
export function focusAreaAnchor(cityItem, block) {
  return (
    focusAreaAnchorByCity[cityItem.name]?.[block] ||
...
export function stayZoneAnchor(cityItem) {
  return (
    stayZoneAnchorByCity[cityItem.name] ||
...
export function cityImageAnchor(cityItem) {
  return cityImageAnchorByCity[cityItem.name] || cleanSearchPlace(cityItem.name);
}
...
function splitCityState(cityName) {
  const [cityPart, statePart] = String(cityName || "")
    .split(",")
    .map((part) => part.trim());
  return {
...
export function imageResearchBrief(cityItem, kind, block = "") {
  if (kind === "hero") {
    ...
    return {
      ...
      rationale:
        "Use the city-scale anchor that best compresses the overall setting and public life into one frame.",
    };
  }
  if (kind === "stay") {
    ...
    return {
      ...
      anchor,
      mapsQuery: formatMapSearchQuery(
        cityItem.name,
        cityItem.heartIntersection || cityItem.stayZone || cityItem.name
      ),
      imageQuery: formatImageSearchQuery(cityItem.name, anchor),
      rationale:
        "Use the nearest public anchor that explains why staying in this zone would feel alive day to day.",
    };
  }
  ...
  return {
    ...
    imageQuery: formatImageSearchQuery(cityItem.name, anchor),
    rationale:
      "Start from the actual block in Maps, then use the nearest meaningful public anchor to find a representative image.",
  };
}
...
export function cityZones(cityItem) {
  ...
  (cityItem.blocks || []).forEach((block, index) => {
    ...
    entry.attractions = uniqueList([
      ...entry.attractions,
      ...zoneAttractions(cityItem, block, anchor),
    ]);
...
export function blockImageIntent(block) {
  if (
    /\bplaza|square|park|waterfront|pier|promenade|wharf|dock|trail|beach|bridge|mall|market\b/i.test(
      block
    )
  ) {
...
function zoneAttractions(cityItem, block, anchor) {
  ...
  if (/\bstate street promenade\b/i.test(anchor))
    attractions.push("State Street cafes", "Lower State storefronts");
...
function zoneKnownFor(cityName, anchor, fallback) {
  if (/\bfunk zone\b/i.test(anchor))
    return "This is the loose, social, food-and-wine zone between downtown and the water: patios, tasting rooms, galleries, and the kind of casual public spillover that makes a place feel used rather than merely admired.";
  if (/\bstate street promenade\b/i.test(anchor))
    return "This is the main all-day pedestrian zone: cafes, storefronts, meals, errands, and the strongest test of whether the city can carry ordinary life on foot from morning through evening.";
  if (/\bcourthouse\b/i.test(anchor))
    return "This is the civic and architectural zone: slower blocks, courthouse texture, shaded edges, and a good test of whether beauty and public life still hold once you step away from the busiest commercial strip.";
  if (/\bstearns wharf\b/i.test(anchor))
    return "This is the waterfront zone: promenade, pier, beach edge, and the daily test of whether the ocean-facing public realm feels like part of life instead of just the scenic reward.";
  if (/\bmission plaza\b/i.test(anchor))
    return "This is the civic-room zone: the plaza, its adjacent restaurant blocks, and the part of town most likely to tell you whether people actually linger and loop here in normal life.";
  if (/\babbott square\b/i.test(anchor))
    return "This is the social core zone: market, food, patios, and the blocks where downtown energy condenses most clearly into visible public life.";
  if (/\blovers point\b/i.test(anchor))
    return "This is the water-edge village zone: coastal path, gathering spots, and the blocks that test whether the place feels magnetic in everyday repetition rather than just in scenic flashes.";
  if (/\bcity dock\b/i.test(anchor))
    return "This is the harbor-room zone: boats, promenades, restaurants, and the blocks where the town most clearly behaves like a real waterfront public square.";
  if (/\bforsyth park\b/i.test(anchor))
    return "This is the public-room zone: the park and its adjacent streets where Savannah's walking rhythm, shade, and social life become easiest to feel in your body.";
  if (/\bbeach drive\b/i.test(anchor))
    return "This is the waterfront urban zone: parks, restaurants, museums, and the stretch where outdoor life, strolling, and city energy overlap most naturally.";
...
export function testSpotBrief(cityItem, block) {
  ...
  let whatToWatch =
    "Walk it once during coffee hours, once around dinner, and once after dark; look for locals, open doors, outdoor seating, errands, and whether lingering feels natural.";

  if (/\bstate st|state street\b/i.test(block)) {
    knownFor =
      "Lower State is the main downtown-to-waterfront spine: restaurants, bars, storefronts, hotels, and the daily test of whether Santa Barbara feels like a real pedestrian city.";
    whatToWatch =
      "Check whether the street has all-day rhythm, not just visitor traffic: coffee, lunch, after-work patios, evening strolling, and how comfortable the walk feels toward the beach.";
  } else if (/\byanonali|helena|funk zone\b/i.test(block)) {
    knownFor =
      "This is the Funk Zone edge: wine rooms, food, galleries, converted industrial buildings, and the less-formal social texture between downtown and the waterfront.";
    whatToWatch =
      "Look for casual spillover into the street: groups moving between places, patios that stay active, gallery or tasting-room energy, and whether it feels useful on a normal weekday.";
  } else if (/\banacapa\b/i.test(block)) {
    knownFor =
      "Anacapa gives you the civic and architectural side of downtown: courthouse texture, older buildings, side-street calm, and a useful contrast to State Street.";
    whatToWatch =
      "Test whether the side streets feel connected or dead: office workers, locals crossing between errands, quiet shade, and whether the beauty supports daily life or just photographs.";
  } else if (/\bstearns wharf|cabrillo|wharf\b/i.test(block)) {
    knownFor =
      "This is the waterfront test: beach promenade, pier, harbor views, mountains over the water, and the strongest public-room feeling near the ocean.";
    whatToWatch =
      "Separate beauty from livability: morning walkers, bike traffic, casual meals, sunset crowds, and whether you would actually return weekly instead of treating it as a vacation set piece.";
  } else if (
    /\bplaza|square|state circle|court square|market square|mission plaza\b/i.test(block)
  ) {
    ...
    whatToWatch =
      "Spend time without a plan. Watch whether people naturally pause, meet, sit, eat, and pass through, or whether it only works during programmed events.";
  } else if (
    /\bwaterfront|harbor|dock|pier|promenade|bay|river|turning basin|ego alley\b/i.test(block)
  ) {
    ...
    whatToWatch =
      "Check morning, afternoon, and evening use. The question is whether the water creates a daily ritual, not just a scenic stop.";
    ...
    whatToWatch =
      "Look for people using it casually: short walks, benches, dogs, lunch breaks, commuting paths, and easy transitions back into cafes or errands.";
    ...
    whatToWatch =
      "Watch storefront continuity, patio life, local errands, evening lights, and whether the block still has pulse when nothing special is happening.";
  }
...
export function normalizeState(nextState) {
  ...
  state.cities.forEach((cityItem) => {
    ...
    cityItem.why ||= "";
    cityItem.heroImage ||= autoImage(
      cityImageQuery(cityItem.name, cityItem.stayZone, cityItem.heartIntersection)
    );
    cityItem.stayZoneImage ||= autoImage(stayZoneImageQuery(cityItem.name, cityItem.stayZone));
    cityItem.blockImages ||= cityItem.blocks.map((block) =>
      autoImage(blockImageQuery(cityItem.name, block))
    );
    cityItem.days ||= [];
    cityItem.checklists ||= {};
...
export function defaultState() {
  return normalizeState({
    cities: structuredClone(starterCities),
    selectedId: starterCities[0].id,
  });
}
