...
function mapPatch(patch) {
  const M = {
    ...
    blocks: "blocks", blockGeometries: "block_geometries", blockBlurbs: "block_blurbs", poiPositions: "poi_positions", walkingCoreCenter: "walking_core_center", status: "status", decision: "decision", isCalibration: "is_calibration", heroImage: "hero_image",
