...
function mapPatch(patch) {
  const M = {
    ...
    blocks: "blocks", blockGeometries: "block_geometries", status: "status", decision: "decision", isCalibration: "is_calibration", heroImage: "hero_image",
    ...
    visitClimate: "visit_climate", crowdSeason: "crowd_season", crowdIntensity: "crowd_intensity", seasonNotes: "season_notes",
